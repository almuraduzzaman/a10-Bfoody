...
const Footer = () => {
    return (
        <div>
            <footer className="bg-gradient-to-r from-gray-100 via-[#fffbbc8a] to-gray-100">
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div>
                            ...
                            <p className="max-w-xs mt-4 text-sm text-gray-600">
                                We’re here to help you go from curious cook to confident in the kitchen.
                            </p>
                        ...
                        <div className="grid grid-cols-2 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div>
                                ...
                                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                    <a className="hover:opacity-75" > Recipe sharing platform </a>
                                    <a className="hover:opacity-75" > Online cooking classes </a>
                                    <a className="hover:opacity-75" > Meal planning and delivery </a>
                                    <a className="hover:opacity-75" > Culinary products and merchandise </a>
                                    <a className="hover:opacity-75" > Personalized recipe services </a>
                                </nav>
                            </div>
                            <div>
                                <p className="font-medium">
